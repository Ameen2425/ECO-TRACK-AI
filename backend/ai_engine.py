...
def get_eco_suggestions(data):
    """
    Generates rule-based suggestions based on user activities.
    """
    suggestions = []
    ...
    # Support food_type and diet_type
...
def predict_future_emissions(user_records):
    """
    Uses Linear Regression to predict next month's total footprint if history exists.
    """
